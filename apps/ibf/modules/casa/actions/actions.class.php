...
//var_dump($direccioncompleta); die();
 $html3 = '<font size="10" color="#0000FF">Informacion de horarios:'.'<br/>'.'
  ...
  // Set some content to print
  $html = "<br/>"."<strong>Bienvenidos</strong> a la Conferencia de la Espada y Fuegos de Evangelismo".
  "<br/>"."<br/>"."Le recibe hno(a): ".$nombre."<br/>"."En calle: ".$calle."
  Ruta: ".$ruta."<br/>"."Colonia: ".$colonia."<br/>"." Municipio de: <cite>".$ciudad." Guanajuato ".$id.
  "</cite><br/>"."<br/>".'<img style="-webkit-user-select: none; cursor: -webkit-zoom-out; " align="middle"
  height="1000" width="1000"src="http://maps.google.com/maps/api/staticmap?&markers=size:mid%7Ccolor:red%7C'
